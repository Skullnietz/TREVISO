...
<head>
    ...
    <title>Treviso - Admin Login</title>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 max-w-5xl w-full bg-white shadow-xl rounded-xl overflow-hidden">
            <div class="flex flex-col justify-center p-8 sm:p-12 lg:p-16">
                <div class="w-full max-w-md mx-auto">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-accent mt-2">Inicia sesion con tu cuenta de empleado</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-6">
                        ...
                        <label class="flex flex-col">
                            <p class="text-gray-900 text-sm font-medium pb-2">Usuario</p>
                            <input name="login" required autofocus class="form-input rounded-lg text-gray-900 border border-gray-300 bg-background-light focus:border-primary focus:ring-2 focus:ring-primary/50 h-12 p-3 text-base" placeholder="Tu usuario" value="{{ old('login') }}"/>
                        </label>
            ...
            <div class="hidden md:flex flex-col items-center justify-center p-12 bg-gradient-to-br from-primary to-secondary">
                <div class="text-center text-white">
                    <span class="material-symbols-outlined text-6xl mb-4">admin_panel_settings</span>
                    <h1 class="text-3xl font-black leading-tight">Gestion de Facturas SAT</h1>
                    <p class="mt-4 max-w-sm mx-auto text-lg font-light opacity-90">Administra clientes, descarga CFDIs y gestiona la contabilidad.</p>
                </div>
            </div>
        </div>
    </div>
